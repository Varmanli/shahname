...
export const SITE_DESCRIPTION =
  "شاهنامه‌سرا؛ آرشیو حماسهٔ ایران: داستان‌ها، شخصیت‌ها و تبارنامهٔ شاهنامه فردوسی با روایتی مدرن، تصویرسازی سینمایی و تجربه‌ای تعاملی از اسطوره‌های ایران‌زمین.";
