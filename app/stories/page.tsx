...
export const metadata: Metadata = pageMetadata({
  title: "روایت‌های شاهنامه",
  description:
    "آرشیو روایت‌های حماسی شاهنامه فردوسی؛ از اسطوره تا پهلوانی و تاریخ، با جستجو، فیلتر شخصیت و ترتیب زمانی برای دنبال‌کردن سیر روایت‌ها.",
  path: "/stories",
});
